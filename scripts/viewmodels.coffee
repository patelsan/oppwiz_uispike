...
class NavigationViewModel
  ...
  createFieldMap: =>
    ...
    this.fieldMap.push({InfoGroup: 'Summary', GroupID:'summary',Fields: ko.observableArray([{Name: 'Opportunity Name', ID: 'opportunityname'}, {Name: 'Opportunity Status', ID: 'opportunitystatus'}, {Name: 'Transaction Type', ID: 'transactiontype'}, {Name: 'Transaction sub type', ID: 'transactionsubtype'}, {Name: 'Close Probability', ID: 'closeprobability'}, {Name: 'Security level', ID: 'securitylevel'}, {Name: 'Client', ID: 'client'}, {Name: 'Client Type', ID: 'clienttype'}, {Name: 'Investor Type', ID: 'investortype'}])})
    ...
    this.fieldMap.push({InfoGroup: 'Key Dates', GroupID:'keydates',Fields: ko.observableArray([{Name: 'Start Date', ID: 'startdate'}, {Name: 'Pitch Proposal Date', ID: 'pitchproposaldate'}, {Name: 'Listing Expiration Date', ID: 'listingexpirationdate'}])})
    ...
    this.fieldMap.push({InfoGroup: 'Competitors', GroupID:'competitors',Fields: ko.observableArray([{Name: 'Primary', ID: 'npt18'}])})
    this.fieldMap.push({InfoGroup: 'Deal costs', GroupID:'dealcosts',Fields: ko.observableArray([{Name: 'Primary', ID: 'npt19'}])})
    this.fieldMap.push({InfoGroup: 'Documents', GroupID:'documents',Fields: ko.observableArray([{Name: 'Primary', ID: 'npt20'}])})
